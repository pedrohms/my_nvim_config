...
_G.packer_plugins = {
  ...
  colorschemes = {
    loaded = true,
    path = "/home/pedro/.local/share/nvim/site/pack/packer/start/colorschemes",
    url = "https://github.com/lunarvim/colorschemes"
  },
  ["copilot.vim"] = {
    loaded = true,
    path = "/home/pedro/.local/share/nvim/site/pack/packer/start/copilot.vim",
  ...
  neovim = {
    loaded = true,
    path = "/home/pedro/.local/share/nvim/site/pack/packer/start/neovim",
    url = "https://github.com/rose-pine/neovim"
  },
  ["nlsp-settings.nvim"] = {
    loaded = true,
    path = "/home/pedro/.local/share/nvim/site/pack/packer/start/nlsp-settings.nvim",
  ...
  ["nvim-gps"] = {
    loaded = true,
    path = "/home/pedro/.local/share/nvim/site/pack/packer/start/nvim-gps",
  ...
  ["telescope-vim-bookmarks.nvim"] = {
    loaded = true,
    path = "/home/pedro/.local/share/nvim/site/pack/packer/start/telescope-vim-bookmarks.nvim",
